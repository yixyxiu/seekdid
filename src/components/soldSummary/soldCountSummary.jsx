 ...
 * @returns 
 */
export const BitSoldCountSummary = (props) => {
    ...
    return (
       <div className='flex flex-col rounded-lg p-5 hover-up-2 bg-sub-card-1st bg-box-shadow'>
            <div className='flex flex-row mb-2' >
                <div className='grow text-sm card-title'>{t('dashboard.summary-count-card-title')}</div>
            </div>
            ...
            :(<div className='mt-2 flex flex-col justify-between'>
                ...
                <div className={`flex flex-row mb-2 border-b-[1px] border-line seperator `}>
                    <div className='px-2 flex grow content-left'>
                        ...
                        <span className='text-base mt-4 ml-1' >{`${t('dashboard.summary-count-unit')}`}</span>
                    </div>
                ...
                
            {
                    props.summaryData.sources?.map((item,i) => {
                        ...
                        <div className='py-2 px-2 flex grow content-center'>
                            ...
                            <span className='text-sm ml-2' >{`${numberFormatter(item.num, 0)} ${t('dashboard.summary-count-unit')}`}</span>
                        </div>
